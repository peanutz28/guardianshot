...
## set the AUDIO_DEVICE_INDEX to the correct USB port number, which has the Mic plugged in
## best to automate this
...
labels = np.load("Labels/augmented_labels.npy")
...
while True:
    ...
    # Example usage
    subject = "Test Email"
    body = "SJUSD: Gunshot sound detected in Hall ABC of Gunderson Elementary. Please investigate"
    ...
    if maximum_frequency_value >= AUDIO_VOLUME_THRESHOLD:
        ...
        if model_1_activated and model_2_activated or model_2_activated and model_3_activated or model_1_activated and model_3_activated:
            ...
            # Sends out an SMS alert send email here
            sms_alert_queue.put("Gunshot Detected")
            send_email(subject, time_of_sample_occurrence + "   " + body, to_email, smtp_server, smtp_port, smtp_username, smtp_password)
